...
img = cv2.imread(r'C:\Users\arnab.000\Desktop\Final Year Project\Dataset\Segmented Medicinal Leaf Images\Alpinia Galanga (Rasna)\AG-S-001.jpg')
...
#                print(gabor_label)
                ...
                cv2.imwrite(gabor_label+'.jpg', filtered_img.reshape(img.shape))
